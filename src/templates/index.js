                ...
                {result && result?.requests && result?.requests.map((value, index) => {
                    return (
                        <tr key={index} id='Table-response-request' >
                            ...
                            <td style={{ fontSize: 8, color: '#000', alignItems: 'center', justifyContent: 'center', padding: 5, justifyItems: "center", alignContent: "center", paddingBottom: 8 }}>{value.risk}</td>
                            <td style={{ fontSize: 8, color: '#000', alignItems: 'center', justifyContent: 'center', padding: 5, justifyItems: "center", alignContent: "center", paddingBottom: 8 }}>{value.riskSuccess}</td>
